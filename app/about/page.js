...
const AboutPage = () => {
  return (
    <div className="min-h-screen px-4 py-12 bg-gray-100 flex items-center justify-center">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-8 sm:p-12">
        ...
        <p className="text-gray-600 text-lg leading-relaxed text-justify">
          We believe in open access, privacy, and speed. Whether you're managing links for your portfolio, products, or personal blog — BitLinks is made to serve you.
        </p>
